...
<div class="panel-group col-sm-2" id="hrms_sidebar_left" role="tablist" aria-multiselectable="true">
    <ul class="nav nav-pills nav-stacked emp_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation"><a href="${pageContext.request.contextPath}/manage_User/findByCondition.do?pageNum=1" >用户信息</a></li>
            </ul>
            <ul class="nav nav-pills nav-stacked">
    ...
    <ul class="nav nav-pills nav-stacked dept_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation"><a href="${pageContext.request.contextPath}/manage_Article/findByCondition.do?pageNum=1" >帖子信息</a></li>
            </ul>
            <ul class="nav nav-pills nav-stacked">
